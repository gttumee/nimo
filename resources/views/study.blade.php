...
<!DOCTYPE html>
    <body>
        <!-- Responsive navbar-->
        <!-- Header-->
        <header  class="bg-image p-5 text-center shadow-1-strong rounded mb-5 text-white"
                ...
                <div class="row gx-5 justify-content-center">
                    <div class="col-lg-6">
                        <div class="text-center my-5">
                            <h1 class="display-5 fw-bolder text-white mb-2">Японд улсад хүссэн чиглэлээрээ суралцах</h1>
                            <p class="lead text-white-50 mb-4">Их дээд сургууль болон коллеж япон хэлний бэлтгэл бүртгүүлэх</p>
            ...
            <div class="container px-5 my-5">
                <div class="row gx-5">
                    <div class="col-lg-4 mb-5 mb-lg-0">
                        ...
                        <h2 class="h4 fw-bolder">Их дээд сургууль</h2>
                        <p>Их дээд сургуулийн оюутан нь гэр бүлийн хамт япон улсад амьдрах боломжтой. Цагын ажилын 7 хоногт 28 цаг ажиллах боломжтой гэр бүлийн хүн мөн адил 28 цаг ажиллах боломжтой</p> 
                    </div>
                    <div class="col-lg-4 mb-5 mb-lg-0">
                        <div class="feature bg-primary bg-gradient text-white rounded-3 mb-3"><i class="bi bi-building"></i></div>
                        <h2 class="h4 fw-bolder">Коллеж</h2>
                        <p>Коллеж </p>
                    </div>
                    <div class="col-lg-4">
                        <div class="feature bg-primary bg-gradient text-white rounded-3 mb-3"><i class="bi bi-toggles2"></i></div>
                        <h2 class="h4 fw-bolder">Хэлний бэлтгэл</h2>
